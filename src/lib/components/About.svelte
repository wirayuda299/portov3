...
<section id="about" class="mx-auto max-w-6xl px-6 py-28">
   <div class="grid items-center gap-14 md:grid-cols-2">
      <div use:reveal class="mx-auto w-full max-w-sm">
         ...
         >
            <div
               class="size-full overflow-hidden rounded-[1.85rem] bg-paper/95 dark:bg-ink/90"
            >
               <img
      ...
      <div use:reveal={{ delay: 120 }}>
         <p
            class="text-sm font-semibold tracking-widest text-brand-500 uppercase"
         >
            About me
         </p>
         <h2
         ...
         >
            Turning ideas into <span
               class="bg-linear-to-r from-brand-500 to-accent-500 bg-clip-text text-transparent"
               >polished products</span
            >
         </h2>
         <p class="mt-6 text-ink/65 dark:text-paper/65">
            I'm a self-taught developer — everything I know came from reading
            docs and building real projects, not a classroom. I care about
            performance, accessibility, and the small interaction details that
            make a product feel alive. When I'm not shipping features, I'm
